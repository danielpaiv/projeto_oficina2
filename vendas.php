...
<head>
    ...
    <title>Vendas</title>
    <style>
        /* Estilos já fornecidos, sem mudanças necessárias aqui */
        body{
...
<body>
    <nav>
        ...
        <button><a href="http://localhost/teste-usuario2/listauser.php">Voltar</a></button>
    </nav>
    <div class="m-5">
    ...
    <script>
        ...
        function filtrarPorData() {
            ...
            const tr = table.getElementsByTagName('tr');
            for (let i = 1; i < tr.length; i++) {
                const td = tr[i].getElementsByTagName('td')[7]; // coluna "Data de Serviço"
                if (td) {
                    const txtValue = td.textContent || td.innerText;
