...
<body>
            ...
            <table id="clientesTabela" class="box">
                ...
                <tbody class="box">
                    ...
                    while ($user_data = $result->fetch_assoc()) {
                        ...
                        <a class= 'btn btn-primary' href='edit_4.php?id=$user_data[id]'>
    ...
    <script>
        ...
        let carrinho = JSON.parse(localStorage.getItem('carrinho_mesa_4_' + userId)) || [];
        ...
        function adicionarAoCarrinho(servico) {
            if (servico.estoque > 0) {
                ...
                .then(data => {
                    if (data.success) {
                        servico.estoque -= 1;
                        localStorage.setItem('carrinho_mesa_4_' + userId, JSON.stringify(carrinho));
                        setTimeout(() => {
        ...
        function carregarCarrinho() {
            const carrinhoLocal = localStorage.getItem('carrinho_mesa_4_' + userId);
            if (carrinhoLocal) {
        ...
        function finalizarCompra() {
            ...
            .then(data => {
                ...
                localStorage.setItem('carrinhoFinalizado_mesa_4_' + userId, JSON.stringify(carrinho));

                carrinho = []; // Limpar o carrinho
                localStorage.removeItem('carrinho_mesa_4_' + userId); // Limpar o localStorage
                atualizarCarrinho();
        ...
        function cancelarVenda() {
            if (confirm("Você tem certeza que deseja cancelar a venda?")) {
                ...
                carrinho = [];
                localStorage.removeItem('carrinho_mesa_4_' + userId);
