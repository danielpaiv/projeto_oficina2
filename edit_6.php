    ...
    <div class="box">
        <form action="saveEdit.php" method="POST">
            ...
            -->
                ...
                <p>pagamento</p>
                <input type="radio" id="dinheiro" name="forma_pagamento" value="dinheiro" <?php echo ($forma_pagamento == "dinheiro") ? 'checked' : ''; ?> required>
                <label for="dinheiro">dinheiro</label>

                <input type="radio" id="debito" name="forma_pagamento" value="debito" <?php echo ($forma_pagamento == "debito") ? 'checked' : ''; ?> required>
                <label for="debito">debito</label>
                
                <input type="radio" id="credito" name="forma_pagamento" value="credito" <?php echo ($forma_pagamento == "credito") ? 'checked' : ''; ?> required>
                <label for="credito">credito</label>

                <input type="radio" id="pix" name="forma_pagamento" value="pix" <?php echo ($forma_pagamento == "pix") ? 'checked' : ''; ?> required>
